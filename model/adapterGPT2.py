...
class GPT2Adapter(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        #     [MixAdapter(self.config, 75, 37) for _ in range(self.config.n_layer)])
    ...
    def add_adapters(self, args):
        ...
        adapter_num = args.number_of_adpt
        # if args.mask:
        #     self.adapter_blocks = nn.ModuleList(
        #         [AdapterMask(self.config, args) for _ in range(self.config.n_layer)])
        # else:
        #     self.adapter_blocks = nn.ModuleList(
